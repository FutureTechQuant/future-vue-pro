...
or with uv
uv run --with simple-ddl-parser convertor.py postgres ../mysql/future-vue-pro.sql > ../postgresql/future-vue-pro.sql
uv run --with simple-ddl-parser convertor.py sqlserver ../mysql/future-vue-pro.sql > ../sqlserver/future-vue-pro.sql
uv run --with simple-ddl-parser convertor.py kingbase ../mysql/future-vue-pro.sql > ../kingbase/future-vue-pro.sql
uv run --with simple-ddl-parser convertor.py opengauss ../mysql/future-vue-pro.sql > ../opengauss/future-vue-pro.sql
uv run --with simple-ddl-parser convertor.py oracle ../mysql/future-vue-pro.sql > ../oracle/future-vue-pro.sql
uv run --with simple-ddl-parser convertor.py dm8 ../mysql/future-vue-pro.sql > ../dm/future-vue-pro-dm8.sql
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help="源数据库脚本路径",
        default="../mysql/future-vue-pro.sql"
    )
